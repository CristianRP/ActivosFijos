 ...
 */
public class ParserXmlListaActivo {

    private static final String ns = null;
    private static final String ETIQUETA_ARRAY = "ArrayOfAF_Lista_Usuario_Activos";
    private static final String ETIQUETA_ITEM = "AF_Lista_Usuario_Activos";
    ...
    private static final String ETIQUETA_TOTAL_ACTIVOS = "totalActivos";
    ...
    public List<ActivoFijo> parsear(InputStream in) throws XmlPullParserException, IOException {
    ...
    private List<ActivoFijo> leerItems(XmlPullParser xmlPullParser)
            throws XmlPullParserException, IOException {

        List<ActivoFijo> mActivo = new ArrayList<>();
    ...
    private ActivoFijo leerItem(XmlPullParser pullParser)
            throws XmlPullParserException, IOException {
        ...
        while (pullParser.next() != XmlPullParser.END_TAG) {
            ...
            switch (name) {
                ...
                case ETIQUETA_ESTADO:
                    ...
                    Log.e("estado", estado);
                    break;
                case ETIQUETA_TOTAL_ACTIVOS:
                    totalActivos = leerTotalActivos(pullParser);
                    TOTAL_ACTIVOS = totalActivos;
                    Log.e("totalActivos", " " + totalActivos);
                    break;
    ...
    private int leerTotalActivos(XmlPullParser pullParser)
            throws XmlPullParserException, IOException {

        pullParser.require(XmlPullParser.START_TAG, ns, ETIQUETA_TOTAL_ACTIVOS);
        int totalActivos = Integer.parseInt(obtenerTexto(pullParser));
        pullParser.require(XmlPullParser.END_TAG, ns, ETIQUETA_TOTAL_ACTIVOS);
